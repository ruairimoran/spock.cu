...
class Problem:
    ...
    def __op(self, prim):
        ...
        #     vi[i] = np.vstack((self.__leaf_cost.Q_sqrt @ x[i + self.__tree.num_nonleaf_nodes],
        #                        half_s, half_s))
    ...
    def __generate_problem_files(self):
        ...
        cost_txt_l = "leafCost"
        if cost[0].is_quadratic or cost[0].is_quadratic_plus_linear:
