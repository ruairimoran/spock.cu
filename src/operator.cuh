 ...
 */
    ...
    void LinearOperator<T>::adj(DTensor<T> &u, DTensor<T> &x, DTensor<T> &y, DTensor<T> &t, DTensor<T> &s,
        ...
        DTensor<T> x_Nonleaf(x, m_matAxis, 0, m_numNonleafNodesMinusOne);
        ...
        memCpy(m_d_scalarWorkspace.get(), &vi, m_tree.numNonleafNodes(), m_numNodesMinusOne, 1, 0, m_data.numStates() + 1, zeroLeaf2Leaf);
